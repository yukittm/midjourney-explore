...
| `2026-06-27_session-handoff-repo-move.md` | 2026-06-27 | One-shot continuity note for the repo move (`~/midjourney-explore` → `~/Desktop/dev/midjourney-explore`); consumed on the first session from the new path. | `.claude/PROGRESS.md` (the standing SSoT). |
