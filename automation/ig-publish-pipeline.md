...
- **Phasing:** Phase 0 = manual hand-run — **DONE + operational** (2 published posts, 2026-06-25 / 06-27); the manual `publish.py` cadence is the **current operating mode**. Phase 1 = scheduled-auto (clock deferred until cadence justifies it).
